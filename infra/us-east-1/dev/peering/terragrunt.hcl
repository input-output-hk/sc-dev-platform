...
terraform {
  source = "git::https://github.com/cloudposse/terraform-aws-vpc-peering/"
}
...
inputs = {
  ...
  requestor_vpc_id  = dependency.vpc_dev_us_east_1.outputs.vpc_id # Management VPC ID
  acceptor_vpc_id   = dependency.vpc_mng_us_east_1.outputs.vpc_id  # EKS VPC ID
}
